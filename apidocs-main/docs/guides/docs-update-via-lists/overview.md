...
* **contents migration** - When migrating to the Global Docs solution, the existing customer contents are transferred to the docs and moved to the top-up Docs account.
